...
class _SavingsDetailsScreenState extends State<SavingsDetailsScreen> {
  final List<String> _defaultCategories = ['LIC', 'SIP', 'Equity', 'IPO'];
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CategoryChipSelector(
                      ...
                      selectedColor: Theme.of(context).extension<ExpenseTrackerAppColors>()!.savings,
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Theme.of(context).extension<ExpenseTrackerAppColors>()!.savings,
            ...
            ElevatedButton(
              onPressed: () {
                if (controller.text.isNotEmpty) {
                  parentContext.read<SavingsBloc>().add(AddCustomCategory(controller.text.trim()));
                  Navigator.pop(ctx);
                }
              },
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final item = state.savings[index];
                      return RecordCard(
                        amount: item.amount,
      ...
      floatingActionButton: BlocBuilder<SavingsBloc, SavingsState>(
        builder: (context, state) {
